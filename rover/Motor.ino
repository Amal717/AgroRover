...
void move_left(){
  move_forward(); 
  int x_left = map(Xaxis, min_x, mid_x, 0, 255);
  speedA = speedA - x_left;
  speedB = speedB + x_left;
...
void move_right(){
  move_forward();
  int x_right = map(Xaxis, mid_x, max_x, 0, 255);
  speedA = speedA + x_right;
  speedB = speedB - x_right;
